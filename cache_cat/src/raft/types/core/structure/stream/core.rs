...
pub(super) struct Pending {
    pub(super) consumer: Vec<u8>,
    pub(super) delivery_ms: u64,
    pub(super) deliveries: u64,
}

#[derive(Clone, Debug)]
pub(super) struct Consumer {
    pub(super) pel: TreeMap<Key, ()>,
...
pub(super) struct Group {
    ...
    pub(super) entries_read: Option<u64>,
    pub(super) pel: TreeMap<Key, Pending>,
    pub(super) consumers: HashMap<Vec<u8>, Consumer>,
    /// Detect destroy/recreate while a SharedStream reader is sleeping.
    pub(super) identity: Arc<()>,
}
impl Group {
    pub(super) fn new(last_delivered: StreamId, entries_read: Option<u64>) -> Self {
        Self {
            last_delivered,
            entries_read,
            pel: TreeMap::new(),
    ...
    pub(super) fn assign(&mut self, key: Key, pending: Pending) {
...
pub struct RedisStream {
    pub(super) entries: TreeMap<Key, Fields>,
    pub(super) groups: HashMap<Vec<u8>, Group>,
    pub(super) last_generated_id: StreamId,
    pub(super) entries_added: u64,
    pub(super) max_deleted_entry_id: StreamId,
